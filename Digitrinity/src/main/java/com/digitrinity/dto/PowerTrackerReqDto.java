...
public class PowerTrackerReqDto {
    ...
    public boolean isAnyFilterEmpty() {
        return this.getClusters().isEmpty() || this.getCustomers().isEmpty() || this.getRegions().isEmpty() || this.getSiteId().isEmpty() || this.getSiteType().isEmpty()
                || this.getZones().isEmpty() || this.getPowerSource().isEmpty() || this.getDeviceType().isEmpty();
    }
}
