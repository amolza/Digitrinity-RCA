...
@Entity
@Immutable
@Table(name = "V_weeklyPerformance")
public class VWeeklyPerformance {
    @Id
    private String smSiteCode;
    private long tranWeek;
    ...
    public long getTranWeek() {
        return tranWeek;
    }

    public void setTranWeek(long tranWeek) {
