...
@Entity
@Immutable
@Table(name = "V_yearlyPerformance")
public class VYearlyPerformance {
    @Id
    private String smSiteCode;
    private long tranYear;
    ...
    public long getTranYear() {
        return tranYear;
    }

    public void setTranYear(long tranYear) {
